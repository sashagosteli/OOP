...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        /**
         * не понимаю почему у меня возраст учителей t1 t2 t3 t4 с 25 не меняется, что
         * бы я не
         * писала, берет только последнюю введенную цифру у t4 в этом случае, что-то
         * такое у меня уже было, но никак не могу решить
         */
